...
<head>
    ...
    @if (empty($_title)) @php $_title = ucwords(str_replace('/', ' ', Request::path())) @endphp @endif
    <title>{{ $_title }} - {{ config('app.name') }}</title>
...
@if (last(request()->segments()) == 'edit' || last(request()->segments()) == 'create')
